...
Architecture orientée objet : Plante > PlanteBrute / Complement / HuileEssentielle
"""
...
class PlanteBrute(Plante):
    """Plante utilisée en l'état : tisane, décoction, macérat, teinture..."""
    TYPE = "brute"
...
class Complement(Plante):
    """Complément alimentaire : gélules, comprimés, ampoules..."""
    TYPE = "complement"
